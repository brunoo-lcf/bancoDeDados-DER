...
-- -----------------------------------------------------
-- Table `db_loja_games`.`table1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`table1` (
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_loja_games`.`produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`produtos` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_produtos_tb_categorias_idx` (`categorias_id` ASC) VISIBLE,
  INDEX `fk_produtos_tb_usuarios1_idx` (`usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_produtos_tb_categorias`
    FOREIGN KEY (`categorias_id`)
    REFERENCES `db_loja_games`.`tb_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produtos_tb_usuarios1`
